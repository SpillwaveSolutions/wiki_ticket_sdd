...
`01M2XCWMVD7KJ01FCNEV1X8231` · subtask/bug · **done**

A garbage line in archive.jsonl must not crash the nightly job, even when no item is open.
...
- [github #418](https://github.com/SpillwaveSolutions/wiki_ticket_sdd/issues/418)
