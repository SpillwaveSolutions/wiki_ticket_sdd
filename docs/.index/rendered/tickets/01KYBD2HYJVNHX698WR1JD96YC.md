...
`01KYBD2HYJVNHX698WR1JD96YC` · epic/feature · **done**
...
and would otherwise false-positive on main. (done)
...
precedent; leave the four pre-commit-content-testing call sites alone. (done)
...
ULID/ticket passes, merge commit message exempt. (done)
...
that fails when HEAD is main/master, right after fail() is defined. (done)
