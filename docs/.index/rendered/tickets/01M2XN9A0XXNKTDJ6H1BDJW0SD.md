...
`01M2XN9A0XXNKTDJ6H1BDJW0SD` · task/bug · **done**

During the plan publish, ticket-sync's close path pushed the linked follow-up items' titles and bodies onto the bug tickets they reference (#377 #344 #382 #383 #381 #385).
