...
`01KYDP0BQGW4XAAGX68526C9ES` · epic/feature · **done**
...
DevOps) and looks up the right integration guide before giving instructions. (done)
...
same 10-section outline so the skill can navigate them predictably. (done)
...
publish ledger recorded all 12 entries correctly. (done)
...
right guide without knowing the skill exists. (done)
...
fetch failure and confirm it falls back to the local copy and says so. (done)
