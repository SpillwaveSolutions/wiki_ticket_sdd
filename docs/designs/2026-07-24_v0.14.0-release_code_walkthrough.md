---
wiki_key: design/2026-07-24_v0.14.0-release-code-walkthrough
doc_type: design
...
2048` (line 31) is "derived from PIPE_BUF … Not a setting." `VERSION = "0.14.0"`
...
Closed in prior releases and still closed at v0.14.0: dispatcher
...
`313b7cd8d903a2aed1115df37bd2002abdd1839d` (tag v0.14.0 on main); all
