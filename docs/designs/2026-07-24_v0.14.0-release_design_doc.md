---
wiki_key: design/2026-07-24_v0.14.0-release-design-doc
doc_type: design
truth_state: snapshot
date: 2026-07-24
name: v0.14.0-release
tag: v0.14.0
git_hash: 313b7cd8d903a2aed1115df37bd2002abdd1839d
branch: main
roadmap_snapshot: docs/roadmap/2026-07-24_v0.14.0-release.md
merged_in: 8401b2513754c7bf54f062cb37386de4e4febc07
---
...
layer for agentic coding, as actually implemented in this repository at v0.14.0.
...
2. **Claude Code plugin** — `plugin/` packages skills, `/worklog:*` commands,
   ...
   `0.14.0` in `plugin/.claude-plugin/plugin.json` locked to `bin/worklog VERSION`
   by `tests/test_plugin.py`. MIT LICENSE shipped. **Drift (Confirmed):**
   `README.md`'s repo-layout table still labels this row "v0.13.0" — stale by
   one release; harmless (cosmetic), tracked in the code walkthrough's Gaps
   section rather than fixed here (this document is generated, not hand-patched).
