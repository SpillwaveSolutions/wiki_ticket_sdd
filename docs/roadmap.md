...
doc_type: roadmap
truth_state: current
source_hash: 4cb360ab
generated_at: 2026-07-22T19:30:52Z
---
...
### IA & content model (supersedes wiki-information-architecture)  ·  P1  ·  7 of 9 done
...
|---|---|---|---|---|---|
| [100](https://github.com/SpillwaveSolutions/wiki_ticket_sdd/issues/100) | Phase 4: ia-graph typed-edge taxonomy + link-pr + trace-check + Traceability Index; propose-only edge seeding via suggestions.jsonl | task | P3 | in progress | — |
