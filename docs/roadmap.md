...
doc_type: roadmap
truth_state: current
source_hash: 00d12547
generated_at: 2026-07-22T20:21:31Z
---
...
| 01KY5QV5 | Schema boundary: split doc.schema.json (documents) from entity schema (items, releases, code-changes) — defer until a second graph entity needs validation | task | P3 | todo | — |
